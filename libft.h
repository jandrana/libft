...
/**
 * @param c integer
 * @return Bool: Returns TRUE when param c is a letter
*/
int				ft_isalpha(int c);

/**
 * @param c integer
 * @return Bool: Returns TRUE when param c is a digit
*/
int				ft_isdigit(int c);

/**
 * @param c integer
 * @return Bool: Returns TRUE when param c is a digit or letter
*/
int				ft_isalnum(int c);

/**
 * @param c integer
 * @return Bool: Returns TRUE when param c is an ASCII character
*/
int				ft_isascii(int c);

/**
 * @param c integer
 * @return Bool: Returns TRUE when param c is printable
*/
 ...
 * size - strlen(dest) - 1 characters and null terminates 
 * it if size != 0.
...
/**
 * @brief Copies up to size - 1 characters from src to dest and nul terminates 
 * it if size != 0.
 * @param dest Destination String
 * @param src Source string to be copied
 * @param size Max characters - 1 to be copied
